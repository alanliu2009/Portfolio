...
import components.weapon.WeaponTargetNearby;
import components.weapon.WeaponType;
import conditions.instant.Damage;
import objects.entity.unit.Unit;
import ui.sound.Sounds;

public class LaserBattery extends WeaponTargetNearby
{
	...
	public static final int ANIM_BEAM_DURATION = 20;
	
	public LaserBattery(Unit owner) 
	{
	...
	public int getNumTargets() 	{		return NUM_TARGETS;		}
