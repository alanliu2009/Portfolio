...
import conditions.instant.RestoreShield;
import objects.entity.Entity;
import objects.entity.unit.Unit;

public class ShieldBattery extends WeaponTargetUnit
{
	public static final int SIZE = 2;
	public static final int MINERAL_COST = 2;
	public static final int MAX_RANGE = 600;
	public static final float SHIELD = 9f;
	...
	public ShieldBattery(Unit owner) 
	{
	...
	{
		return super.canUse() && target != null && inRange(target) && !target.hasMaxShield() && target.canShieldRecover();
	}
	...
	{
		target.addCondition(new RestoreShield(SHIELD));
	}
