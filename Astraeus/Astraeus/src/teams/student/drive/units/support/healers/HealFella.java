...
public class HealFella extends SupportUnit {
	// Hull Healer
	public HealFella(DrivePlayer p, Pod pod) {
		super(p, pod);
	...
	@Override
	protected void determineWeapons() { this.addWeapon(new RepairBeam(this)); }


	@Override
	protected void unitAI() {
		Weapon healingBeam = this.getWeaponOne();
		DriveUnit target = attackPod.mostDamagedAlly(DefenseType.Plating, this);
